...
INSERT INTO pages (title, url_path, page_type, status, published_at, meta_title, meta_description, content) VALUES
  (
    ...
    NOW(),
    'Your Law Firm | Home',
    'Your Law Firm provides experienced legal representation. Call for a free consultation.',
    '[
      {"type": "hero", "title": "Fierce Advocacy When It Matters Most", "subtitle": "Experienced Trial Lawyers Fighting for Maximum Compensation", "showCTA": true},
      ...
      {"type": "testimonials", "testimonials": [
        {"initials": "JM", "text": "Your Law Firm fought tirelessly for my case. They secured a settlement that covered all my medical bills and more.", "rating": 5},
        ...
        {"initials": "TP", "text": "After my truck accident, I was overwhelmed. Your Law Firm handled everything and got me the compensation I deserved.", "rating": 5}
      ]},
      {"type": "cta", "text": "Free Consultation", "phone": "000-000-0000", "variant": "primary"}
    ]'::jsonb
  ),
  (
    'About Us',
    ...
    'published',
    NOW(),
    'About Us | Your Law Firm',
    'Learn about Your Law Firm and our commitment to clients.',
    '[
      {"type": "hero", "title": "About Your Law Firm", "subtitle": "Dedicated Personal Injury Advocates in Atlanta"},
      {"type": "attorney-bio", "name": "Attorney Name", "title": "Founding Partner", "image": "/placeholder.svg", "bio": "Our founding partner established this firm with a singular mission: to provide aggressive, client-focused representation to injury victims. With over 15 years of experience in personal injury law, they have successfully recovered millions of dollars for clients.", "phone": "000-000-0000",
      {"type": "heading", "level": 2, "text": "Our Mission"},
      {"type": "paragraph", "content": "At Your Law Firm, we believe that every injury victim deserves fierce advocacy and personalized attention. We are not a high-volume firm that treats clients like case numbers. Instead, we take the time to understand your unique situation and develop a tailored legal strategy to maximize your recovery."},
      ...
      {"type": "cta", "text": "Schedule Your Free Consultation", "phone": "000-000-0000", "variant": "primary"}
    ]'::jsonb
  ),
  (
    'Practice Areas',
    ...
    'published',
    NOW(),
    'Personal Injury Practice Areas | Your Law Firm',
    ...
    '[
      ...
      {"type": "cta", "text": "Discuss Your Case With Us", "phone": "000-000-0000", "variant": "primary"}
    ]'::jsonb
  ),
  (
    'Contact Us',
    ...
    'published',
    NOW(),
    'Contact Us | Your Law Firm',
    'Contact our experienced lawyers for a free consultation. Call or fill out our contact form.',
    '[
      ...
      {"type": "two-column", "left": [
        ...
        {"type": "paragraph", "content": "Ready to discuss your case? Contact Your Law Firm for a free, no-obligation consultation. We are here to answer your questions and help you understand your legal options."},
        {"type": "paragraph", "content": "<strong>Phone:</strong> 000-000-0000"},
        {"type": "paragraph", "content": "<strong>Address:</strong> "}
      ], "right": [
...
INSERT INTO templates (name, page_type, default_content, default_meta_title, default_meta_description) VALUES
  (
    ...
    'practice',
    '{"hero":{"sectionLabel":"– Practice Area","tagline":"Experienced Legal Representation","description":"Our dedicated team of attorneys brings years of experience and a proven track record of success."},"socialProof":{"mode":"awards","testimonials":[],"awards":{"sectionLabel":"– Recognition","heading":"Awards & Memberships","description":"Our firm has been recognized for excellence.","logos":[]}},"contentSections":[{"body":"<p>Enter your content here...</p>","image":"","imageAlt":"","imagePosition":"right"}],"faq":{"enabled":true,"heading":"Frequently Asked Questions","description":"Find answers to common questions below.","items":[{"question":"How much does a consultation cost?","answer":"We offer free initial consultations."}]}}'::jsonb,
    '[Practice Area] | Your Law Firm',
    'Your Law Firm handles [practice area] cases.'
  ),
  (
    ...
    '[
      ...
      {"type": "cta", "text": "Get Help Now", "phone": "000-000-0000", "variant": "primary"}
    ]'::jsonb,
    '[Campaign] | Your Law Firm',
    'Take action today with Your Law Firm.'
  ),
  (
    ...
    '[
      ...
      {"type": "cta", "text": "Contact Us", "phone": "000-000-0000", "variant": "primary"}
    ]'::jsonb,
    '[Page Title] | Your Law Firm',
    'Your Law Firm - [Page description].'
  );
