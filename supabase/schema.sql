...
CREATE TABLE public.site_settings (
  ...
  footer_column1_label text,
  footer_column2_label text,
  footer_column4_label text,
  footer_logo_text text,
  footer_column4_content text,
  address_line1 text,
  address_line2 text,
  map_embed_url text,
...
SELECT
  ...
  footer_column1_label, footer_column2_label, footer_column4_label,
  footer_logo_text, footer_column4_content,
